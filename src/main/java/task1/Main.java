...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (fibF1 < fibF2) {
			...
			System.out.println("Amount odd= " + amountOddNumFib + " Amount even= " + amountEvenNumFib);
			System.out.println("odd= " + (amountOddNumFib * 100) / (amountOddNumFib + amountEvenNumFib) + "%"
					+ " % even= " + (amountEvenNumFib * 100) / (amountOddNumFib + amountEvenNumFib) + "%");
